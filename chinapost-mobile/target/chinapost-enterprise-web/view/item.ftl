    ...
    <div class="list-item specNames">
        ...
        <div class="list-value" id="specA">
            <#--<#list spec.specValList as specvalue>-->
                ...
                <a data-parent="${spec.spec.specId}" data-value="${spec.goodsSpecDetail.specDetailId}"   class="btn-grey _sku" href="javascript:void(0);">${spec.specValueRemark!''}</a>
            <#--</#list>-->
        </div>
    </div>
</#list>
...
<#--</form>-->
<div class="mobileDesc" style="display: none">${map.detailBean.productVo.goods.mobileDesc!''}</div>
