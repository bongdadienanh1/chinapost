...
$(function(){
    ...
    $(".toBuy").click(function(){
        ...
        if(count<=stock){
            buyNum=buyNum+1;
            location.href="../addproducttoshopmcarl.htm?goodsNum="+count+"&productId="+$("#productId").val()+"&distinctId=1103&subjectId=0";
        }else{
            setTimeout(function(){
                $('.tip-box').remove();
    ...
    var addCartNum=0;
     $("#add_cart").click(function(){
        ...
        if(count<=stock){
            ...
            $.ajax({
                url:"../addproducttoshopcarnew.htm?goodsNum="+$(".product_count").val()+"&productId="+$("#productId").val()+"&distinctId="+$(".ch_distinctId").val()+"&marketingId="+$("#marketingId").val()+"&subjectId=0",
                type:"post",
                success:function(data){
                    if(data > 0){
                        setTimeout(function(){
