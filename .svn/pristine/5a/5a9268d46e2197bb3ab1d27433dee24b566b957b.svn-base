...
<div role="tabpanel" class="upload_body">
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="tab1">
            <form id="uploadForm" action="${bath}/web/uploadPicture" method="post" enctype="multipart/form-data"  target="hidden_frame">
...
<link href="${bath}/static/js/artDialog4.1.7/skins/default.css?4.1.7" rel="stylesheet">
...
<script type="text/javascript" src="${bath}/static/js/common/common_alert.js?version=${VERSION}"></script>
<script>
    //选择图片
    $(function () {
