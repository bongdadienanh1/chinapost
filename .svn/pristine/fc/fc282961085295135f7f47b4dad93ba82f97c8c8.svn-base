package com.ylife.freighttemplate.service;
...
public interface FreightTemplateService {
     ...
     * @return List
     */
    List<FreightTemplate> searchAllTemplateFreightTemplate(FreightTemplate freightTemplate);
    /**
     * 复制模板
     ...
     * @return FreightTemplate
     */
    FreightTemplate selectFreightTemplateDetailFreightTemplate(Long freightTemplateId);
    /**
     * 保存运费模板
     * @param request
     * @return int
