...
public interface GoodsTypeExpandParamMapper {
     ...
     * 
     * @param record
     *            插入的实体 {@link com.ysh.goods.bean.GoodsTypeExpandParam}
     * @return 受影响的行数 {@link java.lang.Integer}
     */
     ...
     * @return 查询到的扩展属性实体 {@link com.ysh.goods.bean.GoodsTypeExpandParam}
     */
     ...
     * 
     * @param record
     *            待更新的实体 {@link com.ysh.goods.bean.GoodsTypeExpandParam}
     * @return 受影响的行数 {@link java.lang.Integer}
     */
