...
public class UploadImgCommon {
    ...
    public static String getPicNamePathSuffix() {
        ...
        picPath = readValue().getProperty("IMAGEPATH") + DateUtil.formatToString(new Date(), "yyyyMMdd") + "/";
        // 根据真实路径创建目录文件
    ...
    public static Properties readValue() {
        ...
        try (InputStream inputStream = UploadImgCommon.class.getClassLoader().getResourceAsStream("upload.properties")) {
            p.load(inputStream);
