...
 */
package com.ylife.shoppingcart.mapper;

import com.ylife.shoppingcart.model.ShoppingCart;
import com.ylife.shoppingcart.model.StoreTemp;
...
public interface ShoppingCartMapper {
     ...
     * @return
     */
    List<StoreTemp> selectStoreTempByCustomerId(Long customerId);
     ...
     * @return int
     */
    int selectSumByCustomerId(Map<String,Object> map);
