    ...
    <div class="mt10">
        ...
        <div class="list-item">
            <h3 class="item-head pr0"><label for="">退款金额</label>
                <span class="curValue">您最多可退款${order.orderPrice!''}邮豆</span>
            </h3>
            <div class="list-value">
                <div class="shuoming">
                    <input type="text" placeholder="${order.orderPrice!''}"  readonly>
                </div>
            </div>
        </div>
        <div class="list-item">
      ...
      <#--  <div class="list-item">
        ...
        <div class="list-item"  style="display:none">
            ...
            <div class="updata-pic">
                <div class="pic-list">
                    <ul>
                        <#--<li><a href="javascript:void(0)"><img src="images/pro-recommend01.jpg" alt=""></a></li>-->
                        <#--<li><a href="javascript:void(0)"><img src="images/pro-recommend02.jpg" alt=""></a></li>-->
                        <li>
                            <div class="uppic">
                                <a href="javascript:;">
                                    <i></i>
        ...
        <input type="hidden" name="orderCode" value="${order.orderCode}" id="orderCode"/>
...
<script type="text/javascript" src="${basePath}/static/js/applybackorder.js?v=201608081739"></script>
<script>
    $(function(){
