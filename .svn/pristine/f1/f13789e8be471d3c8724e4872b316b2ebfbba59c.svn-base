...
<html lang="zh-cn">
  <head>
    ...
    <script src="${basePath}/mobile_home_page/js/jquery.js"></script>
  ...
  <body>
    ...
    <div class="quick_links row">
      <div class="col-xs-3">
      	<a href="${basePath}/list/allproduct" class="link1">
          <i></i>
          <span>全部商品</span>
        </a>
      </div>
      <div class="col-xs-3">
      	<a href="${basePath}/customer/coupon" class="link2">
          <i></i>
          <span>优惠券</span>
        </a>
      </div>
      <div class="col-xs-3">
      	<a href="${basePath}/list/allproduct" class="link3">
          <i></i>
          <span>热门推荐</span>
        </a>
      </div>
      <div class="col-xs-3">
      	<a href="${basePath}/inforlist/1" class="link4">
          <i></i>
          <span>新闻中心</span>
        </a>
      </div>
    ...
    <script src="${basePath}/mobile_home_page/js/bootstrap.min.js"></script>
