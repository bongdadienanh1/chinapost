	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-header pr">
			<ul class="nav-tabs">
				...
				<li><a href="#goods" data-toggle="tab" onclick="queryMobProduct()">货品</a></li>
			</ul><!--/nav-->
						...
						<thead>
							<tr>
								...
								<th style="width:200px;">
								    ...
								    <input type="text" id="chooseGoodsSearch" placeholder="请输入货品名" class="input-medium search-query" style="color:black;">
...
//							+':'+goods.specVo[i].goodsSpecDetail.specDetailName;
                        ...
                        html = html+'<td class="tr"><input type="hidden" class="link" value="item/'+goods.goodsInfoId+'.html"/><button class="ct-choose" onclick="cc(this);">选择</button></td></tr>'
