...
import com.ylife.customer.model.StoreInfo;
 ...
 *
 * @author ggn
 * @see com.ylife.order.model.CreditOrder
 */
@Deprecated
public class BackOrder implements Serializable {
    ...
    public void setMallCurrency(String mallCurrency) {
        this.mallCurrency = mallCurrency;
    }
