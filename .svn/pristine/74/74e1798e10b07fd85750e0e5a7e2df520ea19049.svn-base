<!--<div class="search">
    ...
    <div class="search">
        ...
        <div class="search_box">
            <div class="s_left">
                <img alt="" src="${basePath}/static/img/qianmi_logo.png">
                <a href="javascript:;" class="backto_page">×</a>
            </div>
            <div class="search_form">
                <i class="ion-ios-search-strong"></i>
                <input id="searchInput"   name="goodsInfoName" type="text"  placeholder="搜索商品">
            </div>
            <div class="s_right">
            <#if status?? && status=='0' ><a href="locationset.html"><i class="ion-ios-location-outline"></i></a><#else>
                <a href="javascript:void (0)" ><i  class="iconfont icon-xiaoxi2"></i></a>
            </#if>
...
<script type="text/javascript">
    ...
    function toCates()
    {
        window.location.href="${basePath}/cates.html";
    }

    <#--function toAdminnotice()-->
    <#--{-->
        <#--window.location.href="${basePath}/adminnotice.html";-->
    <#--}-->
