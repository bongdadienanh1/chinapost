 ...
 */
public class MobPageTagGoods implements Serializable{
    private static final long serialVersionUID = -2556222765428208964L;
    /** 编号 */
    private Long pageTagGoodsproductId;
    /** 楼层标签ID */
     ...
     * @return Long
     */
    public Long getPageTagGoodsproductId() {
        return pageTagGoodsproductId;
    }

    /**
     * 商品ID
     * 
     * @param pageTagGoodsproductId
     */
    public void setPageTagGoodsproductId(Long pageTagGoodsproductId) {
        this.pageTagGoodsproductId = pageTagGoodsproductId;
    }
