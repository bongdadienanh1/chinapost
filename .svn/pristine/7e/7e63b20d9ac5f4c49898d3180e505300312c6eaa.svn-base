...
import com.ylife.goods.model.GoodsReleParamVo;
...
public interface GoodsReleParamMapper {
     ...
     * 
     * @param record
     *            需要插入的实体 {@link com.ysh.goods.bean.GoodsReleParam}
     ...
     * 
     * @param record
     *            需要更新的实体 {@link com.ysh.goods.bean.GoodsReleParam}
     ...
     *         {@link com.ysh.goods.util.GoodsReleParamVo}
     */
     ...
     * @return 查询到的实体对象 {@link com.ysh.goods.bean.GoodsReleParam}
     */
