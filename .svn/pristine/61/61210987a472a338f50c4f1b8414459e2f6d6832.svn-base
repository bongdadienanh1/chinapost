...
import com.ylife.freighttemplate.mapper.*;
import com.ylife.freighttemplate.model.*;
import com.ylife.freighttemplate.service.FreightTemplateService;
...
public class FreightTemplateServiceImpl implements FreightTemplateService {
     ...
     * 
     * @see
     * com.ysh.freighttemplate.service.FreightTemplateService#searchAllTemplate
     * (com.ysh.util.PageBean,
     * com.ysh.freighttemplate.bean.FreightTemplate)
     */
    public List<FreightTemplate> searchAllTemplate(FreightTemplate freightTemplate, ArrayList<String> advMappings) {
        // 格式化查询参数
        ...
        if (list != null && !list.isEmpty()) {
            for (int i = 0; i < list.size(); i++) {
                paramMap.put("freightTemplateId",list.get(i).getFreightTemplateId());
                // 查询模板运送方式默认
                List<FreightExpress> fe = freightExpressMapper.selectTemplateExpress(paramMap);

                // 查询所选择的物流公司
                list.get(i).setFreightExpressList(returnFreightExpress(fe,freightTemplate));
            }
        }
        return list;
    }

    public List<FreightExpress> returnFreightExpress(List<FreightExpress> fe,FreightTemplate freightTemplate){
    ...
    public List<FreightTemplate> searchAllTemplate(FreightTemplate freightTemplate) {
        return searchAllTemplate(freightTemplate, null);
    }
     ...
     * com.ysh.freighttemplate.bean.FreightTemplate)
     */
    public List<FreightTemplate> searchAllTemplateFreightTemplate(FreightTemplate freightTemplate){
        ArrayList<String> advMappings=new ArrayList<String>();
        advMappings.add("com.ysh.web.dao.FreightExpressAllMapper.selectExpressAll");
        return searchAllTemplate(freightTemplate, advMappings);
    }
     ...
     * 复制模板
     * 
     * @see com.ysh.freighttemplate.service.FreightTemplateService#
     ...
     * 
     * @see com.ysh.freighttemplate.service.FreightTemplateService#
     * defaultFreightTemplate(com.ysh.freighttemplate.bean.FreightTemplate)
     */
    @Override
    @Transactional
     ...
     */
    public FreightTemplate selectFreightTemplateDetail(Long freightTemplateId, ArrayList<String> advMappings) {
        Map<String, Object> paramMap = new HashMap<>();
        paramMap.put("AdvMappings",advMappings);
        // 查询物流模板详细
        FreightTemplate ft = freightTemplateMapper.selectFreightTemplateById(freightTemplateId);
        if (ft != null) {
            // 查询默认运送方式配置
            paramMap.put("freightTemplateId",ft.getFreightTemplateId());
            List<FreightExpress> fe = freightExpressMapper.selectTemplateExpress(paramMap);
            // 查询所选择的物流公司
            ft.setFreightExpressList(returnFreightExpress(fe,ft));
    ...
    public FreightTemplate selectFreightTemplateDetail(Long freightTemplateId){
       return selectFreightTemplateDetail(freightTemplateId,null);
    }

    public FreightTemplate selectFreightTemplateDetailFreightTemplate(Long freightTemplateId){
        ArrayList<String> advMappings=new ArrayList<String>();
        advMappings.add("com.ysh.web.dao.FreightExpressAllMapper.selectExpressAll");
        return selectFreightTemplateDetail(freightTemplateId, advMappings);
    }
     ...
     * 
     * @see
     * com.ysh.freighttemplate.service.FreightTemplateService#saveFreight
     ...
     * 
     * @see
     * com.ysh.freighttemplate.service.FreightTemplateService#addFreight
     * (javax.servlet.http.HttpServletRequest,
     * com.ysh.freighttemplate.bean.FreightTemplate)
     */
    @Override
     ...
     * 
     * @see
     * com.ysh.freighttemplate.service.FreightTemplateService#getExpressPrice
