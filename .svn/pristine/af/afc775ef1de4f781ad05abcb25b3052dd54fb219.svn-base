...
<#assign basePath=request.contextPath>
    ...
    <link rel="stylesheet" href="http://cdn.bootcss.com/bootstrap-datepicker/1.4.0/css/bootstrap-datepicker.min.css?v=20151016234" >
    ...
    <link rel="stylesheet" href="${basePath}/static/css/third.css?version=${VERSION}"/>
    <style type="text/css">
        .grey{
            background:#DDDDDD;
            color:#428bca;
    ...
    <script type="text/javascript" src="http://cdn.staticfile.org/jquery/1.11.1/jquery.min.js?v=20151016234"></script>
    <script type="text/javascript" src="${basePath}/static/js/jquery.zclip.min.js?v=20151016234"></script>
    <script type="text/javascript" src="${basePath}/static/js/jquery.zclip.js?v=20151016234"></script>
    <script type="text/javascript" src="${basePath}/static/js/bootstrap.min.js?v=20151016234"></script>
    ...
    <script type="text/javascript" src="${basePath}/static/js/app.js?v=20151016234"></script>
...
<div class="modal fade" id="addImg" role="dialog" aria-hidden="true">
    <form id="addnewimage" action="${basePath}/static/saveImageAction.htm" method="post" enctype="multipart/form-data">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" onclick="addImage()" type="button">上传图片</button>
                </div>
            </div>
        </div>
    </form>
