...
import com.ylife.goods.mapper.GoodsReleTagMapper;
import com.ylife.goods.model.GoodsReleTag;
import com.ylife.goods.model.GoodsReleTagVo;
import com.ylife.goods.service.GoodsReleTagService;
...
public class GoodsReleTagServiceImpl implements GoodsReleTagService {
     ...
     * @return 查询到的实体 {@link com.ysh.goods.bean.GoodsReleTag}
     */
     ...
     *
     * @param releTag
     *            待更新的实体 {@link com.ysh.goods.bean.GoodsReleTag}
     * @param username
     *            操作人名称
