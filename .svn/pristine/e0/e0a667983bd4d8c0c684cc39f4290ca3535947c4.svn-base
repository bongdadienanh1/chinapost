    ...
    <div id="ip_cont" class="ip_cont">
                    ...
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href="javascript:void(0);"><img id="" src="http://img01.ylife.cn/1466469684076.jpg" width="100%" widthB="100%" height="50%" heightB="50%" class="" style=""></a>
                            </div>
                        </div>
        ...
        <div class="app_item app_cube" style="display: block;">
            <div class="app_cont" style="height: 320px;position: relative;" id="app_cont1">
                <a href="${basePath}/productdetail?productId=4818"><img id="img1_1_2_2" src="http://img01.ylife.cn/1467264491820.jpg" width="50.0%" widthB="50.0%" height="50.0%" heightB="50.0%" class="imgapp" style="position:absolute;left:0.0%;top:0.0%;"></a><a href="${basePath}/productdetail?productId=4844"><img id="img1_3_2_2" src="http://img01.ylife.cn/1467264494781.jpg" width="50.0%" widthB="50.0%" height="50.0%" heightB="50.0%" class="imgapp" style="position:absolute;left:50.0%;top:0.0%;"></a>
            </div>
        </div>

        <div class="app_item app_cube" style="display: block;">
            <div class="img_adv item" id="img_adv_1">
                <a href="javascript:void(0);"><img id="" src="http://img01.ylife.cn/1466469720057.jpg" width="100%" widthB="100%" height="" heightB="" class="" style=""></a>
            </div>
        </div>
