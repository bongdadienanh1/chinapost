...
import com.ylife.goods.model.GoodsRelatedGoodsVo;
...
public interface GoodsRelatedGoodsMapper {
     ...
     * 
     * @param record
     *            待插入的实体{@link com.ysh.goods.bean.GoodsRelatedGoods}
     * @return 影响的行数
     */
     ...
     *         {@link com.ysh.goods.bean.GoodsRelatedGoods}
     */
     ...
     * @param map
     *            封装参数
     * @return 查询到的关联记录实体{@link com.ysh.goods.bean.GoodsRelatedGoods}
     */
