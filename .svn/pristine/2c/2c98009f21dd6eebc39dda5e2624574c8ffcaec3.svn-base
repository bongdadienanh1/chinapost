...
public interface GoodsSpecMapper {
     ...
     * 
     * @param record
     *            商品规格实体 {@link com.ysh.goods.bean.GoodsSpec}
     ...
     * @return 查询到的规格实体 {@link com.ysh.goods.bean.GoodsSpec}
     */
     ...
     * 
     * @param record
     *            待更新的规格实体 {@link com.ysh.goods.bean.GoodsSpec}
     * @return 更新的行数 {@link java.lang.Integer}
     */
     ...
     * @return
     */
    List<GoodsSpec> queryListForPageGoodsSpec(Map<String, Object> map);
     ...
     * @return
     */
    int queryCountGoodsSpec(GoodsSpec goodsSpec);
     ...
     * @param specId
     *            规格ID {@link java.lang.Long}
     * @return 查询到的Vo对象 {@link com.ysh.goods.vo.GoodsSpecVo}
     */
     ...
     * @return 查询到的Vo对象 {@link com.ysh.goods.vo.GoodsSpecVo}
     */
    GoodsSpecVo querySpecVoBySpecId(Map<String, Object> map);
     ...
     *         {@link com.ysh.goods.bean.GoodsSpec}
     */
    List<GoodsSpec> queryAllSpec(String goodsInfoType);
     ...
     * @return
     */
	int countGoodsBySpecId(String[] specId);
