...
 */
package com.ylife.shoppingcart.service;
...
import com.ylife.shoppingcart.model.MiniShoppingCart;
import com.ylife.shoppingcart.model.ShopCarUtil;
import com.ylife.shoppingcart.model.ShoppingCart;
import com.ylife.shoppingcart.model.ShoppingCartWareUtil;
...
public interface ShoppingCartService {
     ...
     * @return
     */
    Map<String, Object> newsubOrder(HttpServletRequest request, Long[] box, CustomerAddress customerAddress,Long typeId);
     ...
     */
      ...
      * @return int
      */
     int deleteShoppingCartByIds(Long[] shoppingCartId);
     /**
      * 加载cookie中的购物车信息
      * @return 加载好的列表
     * @throws UnsupportedEncodingException 
     ...
     * @param request
     * @param response
     * @param type 1:手机端 2:U宝端
     * @return Map
     */
    Map<String, Object> shopCartMap(HttpServletRequest request,
                                    HttpServletResponse response,Long type);
     ...
     * */
    MiniShoppingCart shopCartMapMobile(HttpServletRequest request,Long type);
