...
public class GoodsProductVo implements Serializable{
    ...
    //关联的规格值的集合
    private List<GoodsProductReleSpec> specVo;
    //创建时间
    private Date goodsInfoCreateTime;
    /**
     * 平台修改时间
     */
    private Date mallGoodsModifiedTime;
    //货品图片的集合
    ...
    public Date getMallGoodsModifiedTime() {
        return mallGoodsModifiedTime;
    }

    public void setMallGoodsModifiedTime(Date mallGoodsModifiedTime) {
        this.mallGoodsModifiedTime = mallGoodsModifiedTime;
    }
    ...
    public List<GoodsProductReleSpec> getSpecVo() {
        return specVo;
    }

    public void setSpecVo(List<GoodsProductReleSpec> specVo) {
        this.specVo = specVo;
    }
