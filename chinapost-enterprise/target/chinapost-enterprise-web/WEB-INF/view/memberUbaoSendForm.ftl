...
<div style="width: 98%">
    <table class="table_list" cellpadding="0" cellspacing="0" align="center">
        ...
        <tr>
            <td style="text-align: center" colspan="7"><img src="${bath}/static/img/nodata.png" width="98%" height="600"></td>
        </tr>
        </tbody>
    </table>
</div>
...
//    array[9] = todayDate.Format("yyyy-MM-dd hh:mm");
    ...
    array1[8] = '';//start
    array1[9] = '';//end
    array1[16] = $(".enterpriseIdChoosen").val();//enterpriseId
    var excel_idCard = '';
    ...
    $(document).on("click",".checkDetail",function(){
        ...
        ajaxPages("../web/api/report/getDetailUcoinGrand","itemContainer2","holder2","memberUbaoSendFormDetail",10,'','',array1);
