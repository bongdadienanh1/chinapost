...
<div class="allheadstyle"><span style="font-size: 18px!important;font-weight:bold;width: 100%!important;text-align: left;padding-left: 20px">报表中心  -  网点供货明细表</span>
</div>
        ...
        <li>
            <div style="margin-left:20px;margin-top:0px;text-align: left!important; position: relative;" class="allinputButton"><span style="display:inline-block;margin-left: 20px;color: #999">单据状态</span>
                <dl id="chooseBillStatus">
                    ...
                    <dd style="text-align: left;margin-left: 22px" data-name="WAIT_DELIVERY"><input type="checkbox" name="billStatesCheckbox" checked="checked"/><span>待发货</span></dd>
                    <dd style="text-align: left;margin-left: 22px" data-name="WAIT_RECEIVER"><input type="checkbox" name="billStatesCheckbox" checked="checked"/><span>待收货</span></dd>
                    <dd style="text-align: left;margin-left: 22px" data-name="WAIT_EDIT"><input type="checkbox" name="billStatesCheckbox" checked="checked"/><span>待修改</span></dd>
                    ...
                    <dd style="text-align: left;margin-left: 22px" data-name="PARTIAL_RECEIPT"><input type="checkbox" name="billStatesCheckbox" checked="checked"/><span>部分收货</span></dd>
                </dl>
        </li>
    ...
    $(document).ready(function(){
        ...
        $("#accSearch").click(function(){
            if(  $("#datetimepicker_end").val() >= $("#datetimepicker_start").val()  && $("#instock_datetimepicker_end").val() >= $("#instock_datetimepicker_start").val() && $("#supply_datetimepicker_end").val() >= $("#supply_datetimepicker_start").val() ){
                ...
                if(array[29] == ""){
                    ...
                    ajaxPages("../web/api/report/getSupplyDetailsForm","itemContainer","holder","supplyDetailForm",10,'','',array,function(){
        ...
        $("#accExport").click(function(){
            ...
            if(lock) {
                ...
                window.location.href = '../web/api/exportExcel/exportSupplyDetailsForm?' + outputStr;
            }else{
