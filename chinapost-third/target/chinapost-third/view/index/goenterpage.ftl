...
<#assign basePath=request.contextPath>
    ...
    <link href="${basePath}/css/material.css?v=20151016234" rel="stylesheet">
    <link href="${basePath}/css/ripples.css?v=20151016234" rel="stylesheet">
    <link rel="stylesheet" href="${basePath}/css/style.css?version=${VERSION}"/>
</head>
<body>
<div class="container">
    <div class="store">
                ...
                <div class="store-select">
                    ...
                    <#--<div class="store-item "  onclick="javascript:window.location.href='index.html'">-->
                        <div class="store-item ">
                            ...
                            <a class="mamage-store-btn" href="sellerinfo.html?n=2&l=17">管理店铺</a>
                        </div>
...
<script src="${basePath}/js/ripples.min.js?v=20151016234"></script>
<script src="${basePath}/js/material.min.js?v=20151016234"></script>
<script type="text/javascript" src="${basePath}/js/third.js?version=${VERSION}"></script>
<script type="text/javascript" src="${basePath}/js/app.js?v=20151016234"></script>
<script type="text/javascript" src="${basePath}/js/navmenu/navmenu.js?v=20151016234"></script>
<script>
    $(function(){
        $.material.init();
    });
