...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="app_cont_3">
        <div class="app_item app_cube" style="display: block;">
            <div class="app_cont_3 item" style="height: 330px;">
                <xsl:attribute name="id">app_cont_3<xsl:value-of select="@id" /></xsl:attribute>
                <xsl:apply-templates select="a"/>
            </div>
            <div class="app_edit" style="width: 100%; height: 100%;">
                <div class="app_btns">
                    <a href="javascript:;" class="edit">
                        <xsl:attribute name="onclick">
                            updateSmf(<xsl:value-of select="@id" />)
                        </xsl:attribute>
                        编辑
                    </a>
                    <a href="javascript:;" class="delete">
                        <xsl:attribute name="onclick">
                            delSmf(<xsl:value-of select="@id" />)
                        </xsl:attribute>
                        删除
                    </a>
                </div>
