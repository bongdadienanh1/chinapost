...
function chooseRollAdv(url){
	...
	'<input type="hidden" id="rollImgAdvSrc'+count+'" name="rollImgAdvSrc"><br/>'+
	'</dd><dd>'+
    '<div class="span1"><span class="xuliehao">序列号：</span><input class="form-control sortBoss" type="text" placeholder="序列号" id="sort'+count+'" name="sort" style="width:75px"></div>'+
    '</dd></dl>' +
...
function updateRollAdvEdit(src,href,sort){
	var _src = src;
	var slides = $("#rollAdvForm").find(".slide");
	var count = slides.length+1;
	_cont = '<div class="slide clearfix">' +
