...
<head>
    ...
    <!-- Bootstrap -->
    <link href="<%=basePath%>css/bootstrap.min.css?version=${VERSION}" rel="stylesheet">
    <link rel="stylesheet" href="<%=basePath%>css/font-awesome.min.css?version=${VERSION}">
    <link href="<%=basePath%>iconfont/iconfont.css?version=${VERSION}" rel="stylesheet">
    <link href="<%=basePath%>css/summernote.css?version=${VERSION}" rel="stylesheet">
    <link href="<%=basePath%>css/zTreeStyle/zTreeStyle.css?version=${VERSION}" rel="stylesheet">
    <link href="<%=basePath%>css/style.css?version=${VERSION}" rel="stylesheet">
...
<script type="text/javascript" src="<%=basePath%>js/jquery.validate.js?version=${VERSION}"></script>
<!-- Include all compiled plugins (below), or include individual files as needed -->
<script src="<%=basePath%>js/bootstrap.min.js?version=${VERSION}"></script>
<script src="<%=basePath%>js/summernote.min.js?version=${VERSION}"></script>
<script src="<%=basePath%>js/language/summernote-zh-CN.js?version=${VERSION}"></script>
<script src="<%=basePath%>js/jqtreetable.js?version=${VERSION}"></script>
<script src="<%=basePath%>js/jquery.ztree.core-3.5.min.js?version=${VERSION}"></script>
<script src="<%=basePath%>js/jquery.ztree.excheck-3.5.min.js?version=${VERSION}"></script>
<script src="<%=basePath%>js/common.js?version=${VERSION}"></script>
<script src="<%=basePath%>js/common/common_alert.js?version=${VERSION}"></script>
<script src="<%=basePath%>js/system/image_cate.js?version=${VERSION}"></script>
</body>
</html>
