...
public class Order implements Serializable {
    ...
    //会员扣减邮豆信息
    private String customerUcoinJson;

    public String getGoodsInfoType() {
        return goodsInfoType;
    }

    public void setGoodsInfoType(String goodsInfoType) {
        this.goodsInfoType = goodsInfoType;
    }

    //订单类型
    private String goodsInfoType;
    ...
    public String getCustomerUcoinJson() {
        return customerUcoinJson;
    }

    public void setCustomerUcoinJson(String customerUcoinJson) {
        this.customerUcoinJson = customerUcoinJson;
    }
