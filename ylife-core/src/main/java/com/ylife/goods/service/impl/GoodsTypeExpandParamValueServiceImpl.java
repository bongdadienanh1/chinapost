...
import com.ylife.goods.mapper.GoodsTypeExpandParamValueMapper;
...
public class GoodsTypeExpandParamValueServiceImpl implements
     ...
     *            属性值实体 {@link com.ysh.goods.bean.GoodsTypeExpandParamValue}
     * @param username
     *            操作人名称
     * @return 添加的行数
     */
     ...
     * @param goodsTypeExpandParamValue
     *            带修改的属性值实体
     *            {@link com.ysh.goods.bean.GoodsTypeExpandParamValue}
     * @param username
     *            操作人名称
     * @return 受影响的行数
     */
