...
import com.ylife.goods.mapper.GoodsTypeBrandMapper;
import com.ylife.goods.model.GoodsBrand;
import com.ylife.goods.model.GoodsTypeBrand;
import com.ylife.goods.model.GoodsTypeBrandVo;
import com.ylife.goods.model.ValueUtil;
import com.ylife.goods.service.GoodsBrandService;
import com.ylife.goods.service.GoodsTypeBrandService;
...
public class GoodsTypeBrandServiceImpl implements GoodsTypeBrandService {
     ...
     *            待插入的实体 {@link com.ysh.goods.bean.GoodsTypeBrands}
     * @param username
     *            操作的用户名
...
//            this.cascDelMapper.cascDel(username);
     ...
     *
     * @param goodsTypeBrand
     *            需要修改的实体 {@link com.ysh.goods.bean.GoodsTypeBrand}
     * @param username
     *            操作的用户名称
     * @return 更新的行数
     */
     ...
     * @return 查询到的实体 {@link com.ysh.goods.bean.GoodsTypeBrand}
     */
     ...
     *         {@link com.ysh.goods.bean.GoodsTypeBrand}
     */
