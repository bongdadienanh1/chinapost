...
public class GoodsProduct implements Serializable {
    ...
    private List<GoodsProductReleSpec> goodsProductReleSpecs;

    public List<GoodsImage> getInfoImages() {
        return infoImages;
    }

    public void setInfoImages(List<GoodsImage> infoImages) {
        this.infoImages = infoImages;
    }

    public List<GoodsProductReleSpec> getGoodsProductReleSpecs() {
        return goodsProductReleSpecs;
    }

    public void setGoodsProductReleSpecs(List<GoodsProductReleSpec> goodsProductReleSpecs) {
        this.goodsProductReleSpecs = goodsProductReleSpecs;
    }
