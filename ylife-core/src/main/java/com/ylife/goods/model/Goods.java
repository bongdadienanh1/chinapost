...
public class Goods implements Serializable {
    ...
    private List<GoodsTypeParam> typeSpecs;

    private List<GoodsProduct> goodsInfos;
    ...
    public List<GoodsProduct> getGoodsInfos() {
        return goodsInfos;
    }

    public void setGoodsInfos(List<GoodsProduct> goodsInfos) {
        this.goodsInfos = goodsInfos;
    }

    public List<GoodsTypeParam> getTypeSpecs() {
        return typeSpecs;
    }

    public void setTypeSpecs(List<GoodsTypeParam> typeSpecs) {
