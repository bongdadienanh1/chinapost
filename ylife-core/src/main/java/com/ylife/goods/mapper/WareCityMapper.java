...
import com.ylife.goods.model.FollowAndCityVo;
import com.ylife.goods.model.WareCity;
...
public interface WareCityMapper {
     ...
     * @param wereId
     */
    List<FollowAndCityVo> selectFollow(Long wereId, BigDecimal productPrices,
            Long goodsId);
