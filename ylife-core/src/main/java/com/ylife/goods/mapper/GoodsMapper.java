...
public interface GoodsMapper {
     ...
     * 
     * @param record
     *            商品实体 {@link com.ylife.goods.model.Goods}
     ...
     * @return 查询到的商品实体 {@link  com.ylife.goods.model.Goods}
     */
     ...
     * 
     * @param record
     *            需要更新的商品实体 {@link  com.ylife.goods.model.Goods}
     * @return 受影响的行数 {@link java.lang.Integer}
     */
     ...
     *         {@link  com.ylife.goods.model.Goods}
     */
     ...
     *
     * @param idList
     * @param pageSize 显示多少个
     * @return List
     */
    List<Object> selectProductSkuList(List<Long> idList,int pageSize);
	 ...
	 * @return
	 */
	int countGoodsByBrandId(@Param("brandId")Long brandId);
