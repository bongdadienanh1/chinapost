...
public interface GoodsProductMapper {
     ...
     * @return
     */
    List<GoodsProductVo> queryListForPageGoodsProduct(Map<String,Object> paramMap);
     ...
     * @return
     */
    int queryCountGoodsProduct(GoodsProduct goodsProduct);
     ...
     * @return
     */
    int batchUpdateAuditStatus(Map<String,Object> map);
